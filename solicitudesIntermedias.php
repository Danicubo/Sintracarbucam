...
$row=[];
$query1 = "SELECT id, fecha, importancia, nombre_completo FROM users WHERE importancia='Intermedio'";
$query2 = "SELECT importancia, COUNT(*) as cantidad FROM users WHERE importancia IN ('Intermedio') GROUP BY importancia";
...
<body>
    <div class="container bg-light">
        ...
        <div class="m-autoa p-2">                                 
            <center>
            <h2 class="text-danger">SE HA INGRESADO A LAS SOLICITUDES INTERMEDIAS</h2>
        ...
        <div class="d-flex flex-row justify-content-around p-2">
            <a href="solicitudesLeves.php"><-Ir Solicitudes Leves</a>
            <a href="solicitudesUrgentes.php">Ir Solicitudes Urgentes-></a>
        </div>
    </div>
