...
$row=[];
$query1 = "SELECT id, fecha, importancia, nombre_completo FROM users WHERE importancia='Leve'";
$query2 = "SELECT importancia, COUNT(*) as cantidad FROM users WHERE importancia IN ('Leve') GROUP BY importancia";
...
<body>
    <div class="container bg-light">
        ...
        <div class="m-autoa p-2">                                 
            <center>
            <h2 class="text-danger">SE HA INGRESADO A LAS SOLICITUDES LEVES</h2>
